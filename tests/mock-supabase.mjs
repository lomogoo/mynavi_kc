...
const db = {
  kc_events: [
    ...
    { id: 4, event_date: '2026-10-18', title: null, venue: null, target_min: 2, target_max: 3, note: null, created_at: new Date().toISOString() },
    { id: 5, event_date: '2026-10-24', title: null, venue: null, target_min: 2, target_max: 3, note: null, created_at: new Date().toISOString() },
